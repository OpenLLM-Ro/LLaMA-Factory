...
class UltraChat(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        file_paths = [dl_manager.download("https://huggingface.co/datasets/OpenLLM-Ro/ro_sft_ultrachat/tree/main/train_{0}_ro.json".format(idx)) for idx in range(10)]  # multiple shards
